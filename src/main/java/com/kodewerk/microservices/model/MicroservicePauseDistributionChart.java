...
public class MicroservicePauseDistributionChart extends Application {
    ...
    private MicroservicePauseDistributionModel model;
    ...
    public void start(Stage primaryStage) {
        ...
        model = new MicroservicePauseDistributionModel();
        ...
        button.setOnAction((event) -> {
            ...
            model.pauseDistribution(probabilityOfSeeingAPause, Integer.valueOf(numberOfNodes.getText()), Integer.valueOf(gcOverHead.getText()));
